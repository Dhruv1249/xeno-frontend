      ...
      <div className="space-y-6">
        {campaigns.length === 0 ? (
          <Card className="p-12 text-center flex flex-col items-center justify-center space-y-4">
            ...
            <div>
              <h3 className="font-sans font-bold text-sm uppercase tracking-wider text-text">No Campaigns Dispatched Yet</h3>
              <p className="text-xs text-text-muted mt-1">Compose and dispatch your first marketing campaign to track its performance here.</p>
            </div>
            <Link href="/campaigns/new">
